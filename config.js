...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '255697242611'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
module.exports = {
  ...
  BRANCH: 'main', 
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? 'Tsup... 😮‍💨 i a🎭 PALCCOD-MD 🎭Whatsapp User Bot 
